...
//Данная функция обрабатывает скрипты нашего проекта
function scripts() {
...
//Данная функция будет обрабатывать стили проекта, конкатенировать и сжимать
function styles() {
	return src('app/' + preprocessor + '/main.' + preprocessor + '') // Выбираем источник
